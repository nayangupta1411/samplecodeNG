...
<html>
	...
	<body >
       ...
       <form name='submitform' method="post" action="res_login_data.php">
      <div class='container mt-4 pt-5  col-lg-6 col-sm-12 col-md-12 p-5 form'>
        <div class='container pr-3 pl-3 py-3'>
        ...
        <div class='container col-lg-12 col-md-9 col-sm-12 p-2 pt-5  content'>
