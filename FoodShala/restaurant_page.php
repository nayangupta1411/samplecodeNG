		...
		<div class='container center  col-lg-12 col-md-12 col-sm-12  header' >
			<div class='container col-sm-12 col-md-12 col-lg-12 pl-5 p-2'>
				...
				<div  class=" pt-3 pr-5 mx-3"style="float:right; font-size: 130%;color: white;">
					<p ><button class="btnn" onclick="window.location.href='index.php'"><b class="mx-3">Logout</b></button>
					<button class="btnn" onclick="window.location.href='order_view_res.php'"><b class="mx-3">Orders</b></button>
					<button class="btnn" onclick="window.location.href='add_menu.php'"><b class="mx-3">Add Item</b></button>
				</p>
				</div>
			</div>
		</div>
	...
	<div class='container mt-4 pt-2  col-lg-6 col-sm-6 col-md-6 form'>
		<div class="row">
			...
			<div class="container-fuild col-lg-5">
				<h1  style="color:#fc0e3d;"><?php echo $row['dish_name']; ?></h1>
			...
			<div class="container-fuild col-lg-3 pt-5 pb-1">
				<div class='container-fuild pt-5 '>
					<div class="container-fuild pt-4 ">
						<button name='submit1' class="pr-1 pl-1 pt-1 pb-1 ml-1 btnn" >Delete</button>
						<button name='submit1' class="pr-3 pl-3 pt-1 pb-1 btnn" >Edit</button>
					</div>
				</div>
			</div>
				</div>
